...
if authentication_status:
    ...
    if dataset_choice == 'PROPERTY STOLEN & RECOVERED':
        ...
        if property_theft_submit_button:
            ...
            st.warning('we see that in the top 10 lowest **case solving rate** and **property recovery rate** we have state 22 which is **Manipur**, followed by state 11 which is **Goa**. So it is advisable to avoid these places.')
            st.error('On the other hand, we see that **Punjab** and **Andaman & Nicobar Islands** has high case recovery rate and property value recovery.')
    ...
    if dataset_choice == 'COMPLAINTS AGAINST POLICE':
        ...
        if complaint_against_police_submit_button:
            ...
            st.subheader("RECOMMENDATIONS")
            st.warning('Here we see that **Madhya Pradesh** has the highest **police_punished_rate** and **complaint_registration_rate**, indicating that there is strict action taken against police in the Indian state of Madhya Pradesh.')
            st.error('Also we see that **Andhra Pradesh** has the lowest **police_punished_rate** and **complaint_registration_rate**, indicating that there is less strict action taken against police in the Andhra Pradesh followed by **Himachal Pradesh**, **Jharkhand** and **Uttar Pradesh**')
